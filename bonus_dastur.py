...
# Text editor dasturi|Ctrl+O fayl ochish uchun|Ctrl+S faylni saqlash uchun| 
# Shunday button yo'qligini meni dangasaligimdan;) 
# Hurmat ila Muzaffar Khaydarov
...
class Window(QWidget):
    ...
    def save_current_file(self):
        if not self.file_path:
            new_file_path, filter_type = QFileDialog.getSaveFileName(self, "Save file", "", "All files (*)")
            if new_file_path:
    ...
    def invalid_path_alert_message(self):
        ...
        messageBox.setText("Please select a valid file.")
        messageBox.exec()
